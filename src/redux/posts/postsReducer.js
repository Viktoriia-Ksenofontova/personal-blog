...
const error = createReducer(null, {
  ...
  [actions.fetchPostsError]: (_, { payload }) => payload.error.message,
  [actions.createPostRequest]: () => null,
  [actions.createPostSuccess]: () => null,
  [actions.createPostError]: (_, { payload }) => payload.error.message,
  [actions.removePostError]: (_, { payload }) => payload.error.message,
